...
let myFavoritePro = "ZywOo";
console.log(myFavoritePro instanceof String);
console.log(typeof myFavoritePro);
upperCasePro = myFavoritePro.toUpperCase();
console.log(upperCasePro);
